...
import 'package:marquee/marquee.dart'; // Dùng để chạy chữ nếu tên bài quá dài
...
class _MusicPlayerScreenState extends State<MusicPlayerScreen> {
  // Hàm format thời gian (ví dụ: 0:00 / 3:45)
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<MusicProvider>(
      builder: (context, provider, child) {
        ...
        // Nếu không có bài hát (lỗi), đóng màn hình này lại
        if (song == null) {
        ...
        return Scaffold(
          backgroundColor: const Color(0xFF121212), // Nền đen chủ đạo
          appBar: AppBar(
            backgroundColor: Colors.transparent,
            elevation: 0,
            leading: IconButton(
              icon: const Icon(Icons.keyboard_arrow_down, color: Colors.white, size: 30),
              onPressed: () => Navigator.pop(context), // Nút đóng
            ),
            ...
            actions: [
              IconButton(
                ...
                onPressed: () {}, // Tính năng mở rộng sau này
              ),
            ],
          ),
          body: Padding(
            ...
            child: Column(
              children: [
                ...
                // 1. ẢNH BÌA LỚN (Có đổ bóng)
                Hero( // Hiệu ứng chuyển cảnh mượt
                  tag: 'album_art',
                  child: Container(
                    height: height * 0.4,
                    width: height * 0.4,
                ...
                SizedBox(
                  height: 40,
                  child: Marquee( // Chữ chạy nếu tên quá dài
                    text: song.title,
                ...
                // 3. THANH SLIDER (TIẾN ĐỘ BÀI HÁT)
                ...
                Row(
                  ...
                  children: [
                    IconButton(
                      ...
                      onPressed: () {}, // Chưa implement
                    ),
                    IconButton(
                      icon: const Icon(Icons.skip_previous, color: Colors.white, size: 36),
                      onPressed: () {}, // Chưa implement logic bài trước
                    ),
                    ...
                    IconButton(
                      ...
                      onPressed: () {}, // Chưa implement logic bài sau
                    ),
                    IconButton(
